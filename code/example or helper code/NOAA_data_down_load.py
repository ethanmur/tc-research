...
def get_frd(folder):
    ...
    url='https://seb.omao.noaa.gov/pub/flight/ASPEN_Data/'+folder
        ...
        if len(entries) > 1:
            ...
            if filename[-3:]=='frd':
                ...
                if len(text_files) < 1 :
                    ...
                    url1='https://seb.omao.noaa.gov/pub/flight/ASPEN_Data/'+folder +filename
...
# download individual folder

folder='20221008H1/'
get_frd(folder)

'''
folders=['20220830H1/','20220831H1/','20220901H1/','20220903H1/','20220904H1/','20220905H1/',
         '20220906H1/','20220907H1/','20220908H1/','20220916H1/','20220917H1/','20220918H1/',
         '20220920H1/','20220924H1/','20220925H1/','20220926H1/','20220927H1/','20221007H1/','20221008H1/']
for folder in folders:
    print(folder)
    get_frd(folder)
'''

#    download range of folder
...
for i in range(304,372):#(298,304):
    folder=dir_all[i]
    print(i, '  ',folder )
    get_frd(folder)
