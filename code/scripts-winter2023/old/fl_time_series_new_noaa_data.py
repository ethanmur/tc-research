...
# filepaths: either = 'old' or 'new'
#  if = 'old', look for data under
def plot( tc='all', max_v_requirement=40, window=10, method='pmin_tlim', timelim=30, ylims=True, filepaths='old'):

    # get a list of all applicable tc years (like previous code) and all the name folders within that year (new)
    year_list, tcname_list = fl_compositing_helpers.get_filenames( tc)
