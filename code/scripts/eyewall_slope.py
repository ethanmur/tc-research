...
def eyewall_slope_first_val( tdr_path, inbound_name, outbound_name):
    ...
    # this code cuts off the eyewall calculation at the first local max in height
...
# algorithm for finding points along the eyewall!
def eyewall_start( tdr_path, inbound_name, outbound_name):
