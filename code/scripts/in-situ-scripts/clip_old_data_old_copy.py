...
# similar to the function above, but this works specifically for trimming the height variable
# found in find_crl_distance.find_crl_dist_in_situ()
def height_helper( crl_path, crl_name, cutoff_indices, return_var, float_time):
