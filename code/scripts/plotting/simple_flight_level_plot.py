...
def plot(crl_path, crl_name, tcdata, counter, xaxis='dist', plot_number=313, togrid=False):
    ...
    # special case to add to a gridded plot!
    if togrid:
        plt.subplot2grid((4,6), (3,0), colspan=6)
        fig = plt.gcf()
        ax1 = plt.gca()
    else:
        fig = plt.gcf()
